...
def test_contact_form_required_fields_are_visible(homepage):
    bmb_main_page = MainPage(homepage)
...
def test_contact_form_required_fields_are_marked(homepage):
    bmb_main_page = MainPage(homepage)
...
def test_valid_name(homepage, name):
    bmb_main_page = MainPage(homepage)
...
def test_invalid_name(homepage, name):
    bmb_main_page = MainPage(homepage)
...
def test_valid_phone(homepage, phone):
    bmb_main_page = MainPage(homepage)
...
def test_invalid_phone(homepage, phone):
    bmb_main_page = MainPage(homepage)
    bmb_main_page.fill_phone(phone)
    bmb_main_page.submit_button_click()
...
def test_valid_email(homepage, email):
    bmb_main_page = MainPage(homepage)
...
def test_invalid_email(homepage, email):
    bmb_main_page = MainPage(homepage)
    bmb_main_page.fill_email(email)
    bmb_main_page.submit_button_click()
...
def test_contact_form_message_validation(homepage):
    bmb_main_page = MainPage(homepage)
...
def test_contact_form_date_picker_is_opened(homepage):
    bmb_main_page = MainPage(homepage)
...
def test_contact_date_cannot_be_filled(homepage: Page) -> None:
    bmb_main_page = MainPage(homepage)
...
def test_contact_form_date_picker_choose(homepage, days_from_today):
    bmb_main_page = MainPage(homepage)
    ...
    date_button = homepage.get_by_role("button", name=date_to_calendar_label(target_date))
...
def test_contact_form_event_type(homepage):
    bmb_main_page = MainPage(homepage)
...
def test_contact_form_choose_event_type(homepage, event_type):
    bmb_main_page = MainPage(homepage)
